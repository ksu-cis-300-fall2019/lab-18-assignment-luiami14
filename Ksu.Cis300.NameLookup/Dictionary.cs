...
namespace Ksu.Cis300.NameLookup
{
    ...
    public class Dictionary<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        /// <summary>
        /// This method returns the result of removing the node with the smallest key from the binary search tree.
        /// </summary>
        /// <param name="t">this is the tree in which you are in</param>
        /// <param name="min">This is the key value pair.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// This method returns the result of removing the node containing the given key from the binary search tree.
        /// </summary>
        /// <param name="key">This is the key for the binary search</param>
        /// <param name="t">this is the tree in which you are in</param>
        /// <param name="removed">this is out parameter called removed.</param>
        /// <returns></returns>
        private static BinaryTreeNode<KeyValuePair<TKey, TValue>> Remove(TKey key, BinaryTreeNode<KeyValuePair<TKey, TValue>> t, out bool removed)
        {
            ...
            else
            {
                ...
                if (p == 0)
                {
                    ...
                    {
                        BinaryTreeNode<KeyValuePair<TKey, TValue>> right = RemoveMininumKey(t.RightChild, out KeyValuePair<TKey, TValue> min);
        ...
        /// <summary>
        /// A method that removes the given ket and the value associated from the dictionary.
        /// </summary>
        /// <param name="k"></param>
        /// <returns></returns>
